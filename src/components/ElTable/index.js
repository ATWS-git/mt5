  ...
  render: function render(h) {
    ...
    return h(
      ...
      [h('colgroup', [this.columns.map(function (column) {
        ...
        attrs: { effect: this.table.tooltipEffect, placement: 'top', content: this.tooltipContent, popperOptions: this.table.tooltipPopperOptions },
        ref: 'tooltip' })])]
    );
  },
  ...
  methods: {
    ...
    handleCellMouseEnter: function handleCellMouseEnter(event, row) {
      ...
      if ((rangeWidth + padding > cellChild.offsetWidth || cellChild.scrollWidth > cellChild.offsetWidth) && this.$refs.tooltip) {
        if(!hoverState.column.customTooltip){
            ...
            tooltip.doDestroy();
            if(cellChild.offsetWidth){
                tooltip.$refs.popper.style.width = `${cellChild.offsetWidth}px`
            }
            tooltip.setExpectedState(true);
            this.activateTooltip(tooltip);
        } else {
            table.$emit('cell-tooltip-mouse-enter', hoverState.row, hoverState.column, hoverState.cell, event, cellChild);
        }
      }
    },
    handleCellMouseLeave: function handleCellMouseLeave(event) {
      ...
      if (tooltip && !oldHoverState.column.customTooltip) {
